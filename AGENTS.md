...
- In the Fourier-plane editor, keep exactly one compact action row below tool size/transmission: spectrum visibility, fully open, fully blocked across the infinite plane, and undo. Do not restore a separate “block visible window” action.
